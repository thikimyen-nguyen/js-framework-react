...
function SingleProduct() {
    const {singleProduct, isError, isLoading, fetchProductById } = useProductsStore();
...
<section className="overflow-hidden ">
  <div className="container mx-auto">
    <div className="lg:w-4/5 mx-auto md:flex ">
      ...
      <img src={singleProduct.image.url} alt={singleProduct.title} className="w-80"  />
      </div>
        <div className="w-full px-6 md:flex-1">
            <h1 className=" mb-1">{singleProduct.title}</h1>
            <div className="flex mb-4">
            <span className="flex items-center">Rating:
                <span className="text-primary ml-3">{singleProduct.rating}/5</span>
            </span>
